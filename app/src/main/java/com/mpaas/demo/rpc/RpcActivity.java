...
public class RpcActivity extends Activity {
    ...
    private CatPictureClient catClient;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        catClient = rpcService.getRpcProxy(CatPictureClient.class);

        initView();
        initRpcConfig(rpcService);
        initCatRpcConfig(rpcService);
    ...
    private void initCatRpcConfig(RpcService rpcService) {
        RpcInvokeContext rpcInvokeContext = rpcService.getRpcInvokeContext(catClient);
        // 设置超时时间，单位ms
        rpcInvokeContext.setTimeout(60000);
        //设置请求头
        Map<String, String> headerMap = new HashMap<>();
        ...
        rpcService.addRpcInterceptor(OperationType.class, new CommonInterceptorTest());
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String result = catClient.v1ImagesSearchGet();
                    showToast(result);
